...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Nov 2024 pada 02.49
...
-- Prosedur
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `hargamasakan` (IN `hrg` INT)   select * from masakan where harga > hrg$$
...
(92, 35, 4, 1, 18000, 'diproses'),
(93, 35, 3, 1, 12000, 'diproses'),
(94, 35, 1, 1, 17000, 'diproses');
...
--
-- Struktur dari tabel `log_masakan`
--

CREATE TABLE `log_masakan` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `log_masakan`
--

INSERT INTO `log_masakan` (`id`, `keterangan`, `created`) VALUES
(1, 'Masakan baru ditambahkan', '2024-06-13 02:11:33');
...
(11, 'mie tektek', 12000, 'Tersedia');

--
-- Trigger `masakan`
--
DELIMITER $$
CREATE TRIGGER `masakaan` AFTER INSERT ON `masakan` FOR EACH ROW BEGIN
    INSERT INTO log_masakan (keterangan)
    VALUES ('Masakan baru ditambahkan');
END
$$
DELIMITER ;
...
(35, 34, '2023-10-25', 6, 'sudah pesan'),
...
--
-- Indeks untuk tabel `log_masakan`
--
ALTER TABLE `log_masakan`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `detail_order`
  MODIFY `id_detail_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
-- AUTO_INCREMENT untuk tabel `log_masakan`
--
ALTER TABLE `log_masakan`
